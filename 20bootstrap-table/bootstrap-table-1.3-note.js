...
!function ($) {
    ...
    BootstrapTable.prototype.init = function () {
        ...
        this.initData();
        this.initToolbar();
        this.initPagination();//分页
        this.initBody();//表格body部分
        this.initServer();
    };
    ...
    BootstrapTable.prototype.initHeader = function () {
        var that = this,
            visibleColumns = [],
            html = [];// 拼装表头的html片段的数组,最后[].join('')转成html字符串,再添加到页面
        ...
        $.each(this.options.columns, function (i, column) {// 遍历options中的所有列
            var text = '',
                style = '',
			...
			//将当前column信息存储到BootstrapTable.header对象中
